...
export const exampleArray = [
	{
		...
		beforeEffect: ({ mc, world, player, target, item, dmg, specialCheck, sweptEntities, crit, sprintKnockback, cooldown, iframes }) => {
		...
		script: ({ mc, world, player, target, item, sweptEntities, dmg, hit, shieldBlock, specialCheck, crit, sprintKnockback, inanimate, cooldown }) => {
			if (hit && !crit) {
